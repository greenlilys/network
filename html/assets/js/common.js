...
(function() {
	...
	/** 测试后台 */
        //  'serviceIP': 'http://192.168.0.121:8080/'
    ...
    //帮助页面
    jumpUrl.help = function() {
        apps.openWin('help', 'bespeak/help/bmap_help_win.html')
    };
    // 平台公告
    ...
    // // 救援列表
    // jumpUrl.rescuelist = function(pageParam) {
    //     apps.openWin('rescuelist', 'bespeak/rescuelist/rescuelist_win.html', pageParam)
    // };

    // 救援列表
    jumpUrl.rescuelist = function(pageParam) {
        apps.openWin('rescue', 'rescue/rescue_win.html', pageParam)
    };

    // 推广二维码
    jumpUrl.promoteQrcode = function(pageParam) {
        apps.openWin('earnintegral', 'my/earnintegral/earnintegral_win.html', pageParam)
    };

    // 操作订单
    jumpUrl.accepts = function(pageParam) {
        apps.openWin('accept', 'accept/accept_win.html', pageParam)
    };

    // 救援地图位置
    jumpUrl.userbmapxy = function(pageParam) {
        apps.openWin('userbmapxy', 'bespeak/rescuelist/userbmapxy_win.html', pageParam)
    };
    // 预约服务详情
