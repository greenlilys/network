...
var vm = new Vue({
    ...
    methods: {
        ...
        getbatterySelect: function() {
            ...
            // alert(JSON.stringify(vm.batteryselect.batteryList));
            if (vm.batteryselect.batteryList[0].appointnum || vm.batteryselect.batteryList[1].appointnum || vm.batteryselect.batteryList[2].appointnum) {
              alert(vm.batteryselect.batteryList[0].name + "预约数量：" + vm.batteryselect.batteryList[0].appointnum + "\n" + vm.batteryselect.batteryList[1].name + "预约数量：" + vm.batteryselect.batteryList[1].appointnum + "\n" + vm.batteryselect.batteryList[2].name + "预约数量：" + vm.batteryselect.batteryList[2].appointnum);
            }
        },
        // 加减选择
